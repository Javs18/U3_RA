<?php
$conexion=mysqli_connect('localhost','root','oscarmtz916','clinica');
?>
	...
	<div class="main-top">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="wel-nots">
						<p>Bienvenidos a Análisis Clínicos</p>
					</div>
					<div class="right-top">
						<ul>
					...
					<div class="owl-carousel owl-theme">
						...
						<div class="item">
							<div class="serviceBox">
								...
								<p class="description">
									En esta seccion usted podra ver un calendario en el cual puede agendar una cita, puede modificarla y cambiarla de dia. Cuenta con un sistema de seleccion decolores.
								</p>
								<a href="../V.5.0.0/calendario/index.php" class="new-btn-d br-2">Leer Mas</a>
							</div>
						</div>
